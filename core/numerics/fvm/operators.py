...
def compute_periodic_pressure_poisson_term(
    p: np.ndarray,
    b: np.ndarray,
    nit: int, 
    dist_x: np.ndarray,
    ...
    for q in range(nit):
        ...
        p[-1, 1:-1] =(f_e_top + f_w_top + f_s_top - b[-1, 1:-1] * cell_volumes[-1, 1:-1]) / (a_w_top + a_e_top + a_s_top)
        ...
        p[1:-1, 0] =(f_e_left + f_w_right + f_n_left + f_s_left - b[1:-1, 0] * cell_volumes[1:-1, 0]) / (a_e_left + a_w_right + a_s_left + a_n_left)
        ...
        p[1:-1, -1] =(f_e_left + f_w_right + f_n_right + f_s_right - b[1:-1, -1] * cell_volumes[1:-1, -1]) / (a_e_left + a_w_right + a_s_right + a_n_right)
        ...
        p[0, 0] =(f_e_bottom_left + f_w_top_right + f_n_bottom_left - b[0, 0] * cell_volumes[0, 0]) / (a_e_bottom_left + a_w_top_right + a_n_bottom_left)
        ...
        p[-1, 0] =(f_e_top_left + f_s_top_left - b[-1, 0] * cell_volumes[-1, 0]) / (a_e_top_left + a_s_top_left)
        ...
        p[0, -1] =(f_e_bottom_left + f_w_bottom_right + f_n_bottom_right - b[0, -1] * cell_volumes[0, -1]) / (a_e_bottom_left + a_w_bottom_right + a_n_bottom_right)
        ...
        p[-1, -1] =(f_w_top_right + f_s_top_right - b[-1, -1] * cell_volumes[-1, -1]) / (a_w_top_right + a_s_top_right)
