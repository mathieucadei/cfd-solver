...
def compute_convection_2d_term(
    ...
    u_term[1:-1, 1:-1] = u[1:-1, 1:-1] * dt / dx * (u[1:-1, 1:-1] - u[1:-1, 0:-2]) + v[1:-1, 1:-1] * dt / dy * (u[1:-1, 1:-1] - u[0:-2, 1:-1])
    v_term[1:-1, 1:-1] = u[1:-1, 1:-1] * dt / dx * (v[1:-1, 1:-1] - v[1:-1, 0:-2]) + v[1:-1, 1:-1] * dt / dy * (v[1:-1, 1:-1] - v[0:-2, 1:-1])
