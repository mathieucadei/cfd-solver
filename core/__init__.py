...
from .setup.grids import make_1d_grid, compute_dx
from .setup.time_stepping import compute_dt
from .setup.initial_conditions import hat_initial_condition
from .numerics import solve_advection_1d, solve_convection_1d, solve_diffusion_1d, solve_burgers_equation_1d
from .analytical import solve_heat_equation_1d
