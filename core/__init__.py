from .config import Advection1DConfig, Advection2DConfig, Convection1DConfig, Convection2DConfig, Diffusion1DConfig, BurgersEquation1DConfig
...
from .numerics import solve_advection_1d, solve_advection_2d, solve_convection_1d, solve_convection_2d, solve_diffusion_1d, solve_burgers_equation_1d
