...
poisson_2d_config = fvm.Poisson2DConfig(
...
hx_array, hy_array = fvm.build_h_spacing(poisson_2d_config)
xc_array, yc_array = fvm.build_centers(poisson_2d_config)

# Initialize the initial condition

initial_condition = fvm.poisson_initial_condition_2d(poisson_2d_config)



# Solve the poisson equation

solution_matrix = fvm.solve_poisson_2d(initial_condition, config=poisson_2d_config)
...
xf, yf = fvm.build_face_positions(poisson_2d_config)
