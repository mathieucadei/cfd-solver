...
cavity_flow_config = CavityFlowFVMConfig(
...
hx_array, hy_array = build_h_spacing(cavity_flow_config)
xc_array, yc_array = build_centers(cavity_flow_config)


# Initialize the initial condition

initial_condition = cavity_flow_initial_condition_fvm(cavity_flow_config)



# Solve the poisson equation

solution_matrix = solve_cavity_flow_fvm(initial_condition, config=cavity_flow_config)
